...
class DALPayments(
    ...
    async def upsert_by_stripe_pi(
        ...
        values: dict[str, Any] = {
            ...
            "fulfillment_last_error": payload.fulfillment_last_error,
        ...
        stmt = (
            ...
            .on_conflict_do_update(
                ...
                set_={
                    ...
                    "share_create_request": values["share_create_request"],
                    "fulfilled_at": values["fulfilled_at"],
                    "fulfillment_last_error": values["fulfillment_last_error"],
